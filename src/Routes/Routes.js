...
const RoutesData = [
  ...
  { path: "/header", element: Header, name: "header Page" },
  { path: "/footer", element: Footer, name: "footer Page" },
  { path: "/home", element: HomePage, name: "home Page" },
  { path: "/remainder", element: Remainder, name: "remainder Page" },
